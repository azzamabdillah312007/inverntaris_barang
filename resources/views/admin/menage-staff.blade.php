...
@section('judul', 'Admin|Menage-staff')
@section('halaman', 'Pengelola Staff ')
...
@section('body')
    ...
    <div class="p-8">
        ...
        <div class="flex justify-between mt-5">
            ...
            <button type="button"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><a href="/admin/menage-staff/added-staff">Tambah Staff</a></button>
        </div>
        {{-- table staff --}}
