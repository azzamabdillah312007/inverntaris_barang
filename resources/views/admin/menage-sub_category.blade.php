...
@section('judul', 'Admin|Menage-Sub_Category')
@section('halaman', 'Pengelola Sub Kategori Barang')


@section('body')

    <div class="p-8">
        <h1 class="text-4xl font-semibold text-gray-800">Table Sub Kategori barang</h1>
        ...
        <div class="flex justify-between mt-5">
            <input type="text" id="first_name"
                ...
                placeholder="Cari berdasarkan nama sub categori" required />
            <button type="button"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><a
                    href="/admin/menage-sub_category/added-sub_category">Tambah Sub Kategori</a></button>
        </div>
        {{-- table staff --}}
        <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md mt-5">
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Nama Sub Kategori</th>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    @foreach ($sub_category as $sub_category)
                        <tr class="hover:bg-gray-50">
                            <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                                <div class="font-medium text-gray-700">{{ $sub_category->name }}</div>
                            </th>
                            <td class="px-6 py-4">
                    ...
                    <tr class="hover:bg-gray-50">
                        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                            <div class="font-medium text-gray-700">Baju Polo</div>
                        </th>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs font-semibold">
                                Barang awet tahan lama
                    ...
                    <tr class="hover:bg-gray-50">
                        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                            <div class="font-medium text-gray-700">Celana jeans</div>
                        </th>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs font-semibold">
                                Barang awet tahan lama
