    ...
    <div class="p-8">
        ...
        <div class="flex justify-between mt-5">
            <input type="text" id="first_name"
                ...
                placeholder="Cari berdasarkan nama pelanggan" required />
            <button type="button"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><a
                    href="/admin/menage-transaction/added-transaction">Tambah Transaksi</a></button>
        </div>
        {{-- table staff --}}
        <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md mt-5">
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead class="bg-gray-50">
                    <tr>
                        {{-- <th scope="col" class="px-6 py-4 font-medium text-gray-900">Id transaksi</th> --}}
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">ID item</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Penambahan/Pengurangan</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Status</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">notes</th>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        {{-- <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                            ...
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">1212OX</div>
                            </div>
                        </th> --}}
                        <td class="px-6 py-4">
