...
@section('body')
    ...
    <div class="p-8">
        ...
        <div class="w-full mt-8">
            <form action="{{ route('staff.added-item') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-lg w-full border p-8">
                @csrf
                <div>
